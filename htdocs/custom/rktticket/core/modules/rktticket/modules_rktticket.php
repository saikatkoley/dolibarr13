 ...
 */
abstract class ModelePDFRktTicket extends CommonDocGenerator
{
	var $error='';
...
abstract class ModeleNumRefTickets
{
	var $error='';
 ...
 *  @deprecated Use the new function generateDocument of Ticket class
 *  @see RktTicket::generateDocument()
 */
function ticket_pdf_create(DoliDB $db, Ticket $object, $modele, $outputlangs, $hidedetails=0, $hidedesc=0, $hideref=0)
{
